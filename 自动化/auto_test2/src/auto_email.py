...
class a_email():
    def __init__(self):
        ...
        self.mail_user = "leketest@163.com"   #邮件发送者账号
        self.mail_password = "leketest123"     #发送邮箱的授权码
        self.sender = "leketest@163.com"    #与发送者相同
        self.reciver = "leketest@qq.com"  #邮件接收者
...
if __name__ == '__main__':
    ae = a_email()  #创建类的对象
    report = r"D:\python_work\auto_test0605\web_test\report\Auto.html"
